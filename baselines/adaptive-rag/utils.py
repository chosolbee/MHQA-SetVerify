...
def preprocess_features_function(examples, args, raw_datasets, tokenizer):
    ...
    for i in range(len(model_inputs["input_ids"])):
        ...
        key = "id" if "id" in examples else ("question_id" if "question_id" in examples else None)
        model_inputs["example_id"].append(examples[key][sample_index] if key else f"example_{sample_index}")
